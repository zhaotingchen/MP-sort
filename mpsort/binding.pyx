...
cdef void * pymalloc(const char * name, size_t size, const char * file, int line, void * userdata) except? NULL:
    return PyMem_Malloc(size)

cdef void pyfree(void * ptr, const char * file, int line, void * userdata) except*:
    PyMem_Free(ptr)
